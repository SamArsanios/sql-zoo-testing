-- Eercise-2 -- SELECT from World --> In which we query the World country profile table
...
-- 11. Each of the strings 'Greece', and 'Athens' has 6 characters.
...
-- You can use <> as the NOT EQUALS operator. The capital of Sweden is Stockholm. Both words start with the letter 'S'.
