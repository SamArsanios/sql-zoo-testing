-- Eercise-7 -- More JOIN operations --> In which we join actors to movies in the Movie Database.
...
SELECT name FROM actor
  JOIN casting ON (actor.id = actoridAND (SELECT COUNT(ord) FROM casting
